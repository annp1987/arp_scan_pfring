...
func scan(iface *net.Interface) error {
	...
	handle, err := pfring.NewRing(iface.Name, 65536, pfring.FlagPromisc)
	if err != nil {
		//return err
		// try to open zc:iface
		zcIface := "zc:10@0"
		handle, err = pfring.NewRing(zcIface, 65536, pfring.FlagPromisc)
		if err != nil {
			return err
		}
	}
...
func readARP(handle *pfring.Ring, iface *net.Interface, stop chan struct{}) {
...
// pcap handle.
func writeARP(handle *pfring.Ring, iface *net.Interface, addr *net.IPNet) error {
